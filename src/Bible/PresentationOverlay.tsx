    ...
    >
      ...
      <div className="absolute top-0 left-0 right-0 p-4 flex justify-between items-center z-10 bg-gradient-to-b from-black/70 to-transparent">
        ...
        {currentVerse && totalVerses && (
          <div className="text-white font-semibold px-4 py-2 bg-black/40 backdrop-blur-sm rounded-lg text-sm md:text-sm">
        ...
        <div className="flex gap-2">
          {textOverflows && (
            ...
            >
              <span className="text-[0.9rem] font-medium">Auto</span>
            </button>
          )}
          <button
      ...
      <div className="absolute bottom-4 left-0 right-0 flex justify-center">
        <div className="text-white/70 text-[0.9rem] bg-black/40 backdrop-blur-sm px-3 py-1.5 rounded-full flex gap-4 flex-wrap justify-center">
          <span>← → Navigate</span>
