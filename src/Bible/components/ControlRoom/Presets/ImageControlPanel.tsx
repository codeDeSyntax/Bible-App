...
export const ImageControlPanel: React.FC<ImageControlPanelProps> = ({
  ...
  return (
    <div className="mt-3">
      <div className="relative bg-white/80 dark:bg-black/40 rounded-2xl p-4 border border-white/30 dark:border-white/10 shadow-lg backdrop-blur-sm w-80 shadow-[inset_0_2px_8px_rgba(0,0,0,0.06)] dark:shadow-[inset_0_2px_8px_rgba(0,0,0,0.3)]">
        ...
        <div className="relative">
          ...
          <div className="flex gap-3">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div
                onClick={handleReset}
                className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#313131] to-[#303030] hover:from-[#303030] hover:to-[#6b4931] border border-[#313131]/50 shadow-md shadow-[#313131]/50 transition-all duration-200 flex items-center justify-center group active:scale-95 shadow-[inset_0_1px_2px_rgba(255,255,255,0.1),inset_0_-1px_3px_rgba(0,0,0,0.3)] active:shadow-[inset_0_2px_6px_rgba(0,0,0,0.5)]"
                title="Reset"
              >
