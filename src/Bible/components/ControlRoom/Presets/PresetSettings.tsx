          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="w-8 h-8 rounded-lg bg-white/60 dark:bg-black/20 text-gray-700 dark:text-gray-300 hover:bg-white/80 dark:hover:bg-black/30 transition-all duration-200 font-bold text-base shadow-md flex items-center justify-center"
              >
                −
              </button>
              ...
              <button
                ...
                className="w-8 h-8 rounded-lg bg-gradient-to-r from-[#313131] to-[#303030] text-white hover:from-[#303030] hover:to-[#303030] transition-all duration-200 font-bold text-base shadow-md flex items-center justify-center"
              >
                +
              </button>
            </div>
