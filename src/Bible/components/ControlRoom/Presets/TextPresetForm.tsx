      ...
      <div className="space-y-2">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-2 py-1.5 text-xs rounded-lg border-none bg-white dark:bg-[#0f0c0a] text-stone-900 dark:text-white focus:outline-none focus:bg-stone-200 dark:focus:bg-[#1a1410] transition-colors"
          >
        ...
        <div style={{ display: "none" }}>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-2 py-1.5 text-xs rounded-lg border-none bg-white dark:bg-[#0f0c0a] text-stone-900 dark:text-white placeholder-stone-400 dark:placeholder-stone-500 focus:outline-none focus:bg-stone-200 dark:focus:bg-[#1a1410] resize-none transition-colors"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-2 py-1.5 text-xs rounded-lg border-none bg-white dark:bg-[#0f0c0a] text-stone-900 dark:text-white placeholder-stone-400 dark:placeholder-stone-500 focus:outline-none focus:bg-stone-200 dark:focus:bg-[#1a1410] transition-colors mb-1"
          ...
          {loadingFonts ? (
            <div className="w-full px-2 py-8 text-xs rounded-lg bg-white dark:bg-[#0f0c0a] flex flex-col items-center justify-center gap-2">
              <div className="animate-spin rounded-full h-6 w-6 border-2 border-stone-300 dark:border-stone-600 border-t-[#313131] dark:border-t-[#b8835a]"></div>
            ...
            <select
              ...
              className="w-full px-2 no-scrollbar py-1.5 text-xs rounded-lg border-none bg-white dark:bg-[#0f0c0a] text-stone-900 dark:text-white focus:outline-none focus:bg-stone-200 dark:focus:bg-[#1a1410] transition-colors"
              size={5}
            >
              {fontOptions
                .filter((font) =>
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                value={textColor}
                onChange={(e) => setTextColor(e.target.value)}
                className="flex-1 px-2 py-1 text-xs rounded bg-white dark:bg-[#0f0c0a] text-stone-900 dark:text-white border border-stone-300 dark:border-stone-600"
              />
            </div>
          </div>
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                onChange={(e) => setBackgroundColor(e.target.value)}
                disabled={useBackgroundImage}
                className="flex-1 px-2 py-1 text-xs rounded bg-white dark:bg-[#0f0c0a] text-stone-900 dark:text-white border border-stone-300 dark:border-stone-600 disabled:opacity-50 disabled:cursor-not-allowed"
              />
            </div>
          </div>
        </div>
          ...
          {useBackgroundImage && (
            <div className="space-y-2 mt-2">
              ...
              <button
                ...
                className="w-full px-3 py-2 text-xs rounded-lg bg-white/80 dark:bg-black/40 text-stone-900 dark:text-white border border-stone-200/50 dark:border-white/10 focus:outline-none transition-all flex items-center justify-center gap-2 hover:bg-stone-50 dark:hover:bg-black/60"
              >
