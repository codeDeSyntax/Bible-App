...
const ReaderSettingsDropdown: React.FC = () => {
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar">
        {bookmarks.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-[0.9rem] text-gray-400 dark:text-gray-500">
      ...
      <div className="mb-3">
        ...
        <div className="flex items-center space-x-3 mt-2.5">
          <div
            ...
            className="flex items-center space-x-1.5 text-[0.9rem] text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100 transition-colors cursor-pointer"
          >
            {exactMatch ? (
  ...
  const renderSettingsView = () => (
    <div className="p-4 space-y-5 h-full z-50">
      {/* Reading View Toggle */}
      <div>
        <div className="text-[0.9rem] font-medium text-gray-600 dark:text-[#f9fafb] mb-3 uppercase tracking-wide">
          Reading View
        </div>
        <div className="flex bg-gray-100/80 dark:bg-[#303030] rounded-xl p-1.5">
          <div
            onClick={() => dispatch(setViewMode("block"))}
            className={`flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-[0.9rem] font-medium transition-all duration-200 ${
              viewMode === "block"
      ...
      <div className="pt-3 border-t border-gray-200/50 dark:border-gray-700/50">
        ...
        <div className="text-center py-4 px-3 rounded-xl border border-gray-200/50 dark:border-gray-700/50 bg-gradient-to-r from-primary/5 to-primary/10 dark:from-[#2c2c2c] dark:to-[#2c2c2c]">
          ...
          <div className="text-[0.9rem] text-gray-500 dark:text-[#f9fafb]">
            John 3:16
          </div>
        </div>
      </div>
          ...
          >
            <div className="flex items-center gap-3">
              <div className="text-left">
                ...
                <div className="text-[0.9rem] text-[#f0fafb]">
                  {option.description}
                </div>
              </div>
            </div>
