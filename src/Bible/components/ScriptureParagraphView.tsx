...
//       }
//     >
//       {/* Add wheat background watermark when not in image background mode and setting is enabled */}
//       {showWatermarkBackground && (
//         <BookWatermarkBackground isDarkMode={isDarkMode} />
//       )}

//       {/* Floating watermark toggle - only show when not in image background mode */}
...
//                       <span className="text-[0.9rem] text-gray-600 dark:text-gray-300 font-medium">
//                         Highlight:
//                       </span>
...
//                         >
//                           <span className="text-[0.9rem] font-bold text-gray-700 dark:text-gray-200">
//                             ×
//                           </span>
//                         </div>
//                       </div>
...
//                       <div className="w-8 h-8 rounded-full bg-gradient-to-br from-stone-600 to-amber-700 dark:from-stone-600 dark:to-stone-500 flex items-center justify-center text-white text-[0.9rem] font-semibold shadow-sm group-hover:shadow-md transition-all duration-300 group-hover:scale-105">
//                         {currentChapter + 1}
//                       </div>
//                       <div className="text-[0.9rem] text-stone-500 dark:text-stone-400 mt-1">
//                         Ch.
//                       </div>
//                     </div>
...
//                         Continue Reading
//                       </div>
//                       <div className="text-[0.9rem] text-stone-500 dark:text-stone-400 group-hover:text-stone-600 dark:group-hover:text-stone-300 transition-colors duration-300">
