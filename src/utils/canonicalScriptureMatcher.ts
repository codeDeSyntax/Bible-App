...
const CANONICAL_BOOKS: Record<string, string[]> = {
  ...
  Ruth: ["ruth", "rth"],
  "1 Samuel": ["1 samuel", "1st samuel", "first samuel", "1 sam", "1sam", "1sa", "i samuel", "i sam"],
  "2 Samuel": ["2 samuel", "2nd samuel", "second samuel", "2 sam", "2sam", "2sa", "ii samuel", "ii sam"],
  "1 Kings": ["1 kings", "1st kings", "first kings", "1 kgs", "1kgs", "1ki", "i kings", "i kgs"],
  "2 Kings": ["2 kings", "2nd kings", "second kings", "2 kgs", "2kgs", "2ki", "ii kings", "ii kgs"],
  ...
  Ecclesiastes: ["ecclesiastes", "eccles", "ecc", "qoh"],
  "Song of Solomon": ["song of solomon", "song of songs", "canticles", "sos", "cant"],
  Isaiah: ["isaiah", "isa"],
  ...
  Galatians: ["galatians", "galatian", "gal"],
  Ephesians: ["ephesians", "ephesian", "eph"],
  Philippians: ["philippians", "philippian", "phil", "php"],
  Colossians: ["colossians", "colossian", "col"],
  ...
  "1 Timothy": ["1 timothy", "1st timothy", "first timothy", "1 tim", "1ti", "i timothy"],
  "2 Timothy": ["2 timothy", "2nd timothy", "second timothy", "2 tim", "2ti", "ii timothy"],
  Titus: ["titus", "tit"],
  Philemon: ["philemon", "philem", "phm"],
  Hebrews: ["hebrews", "hebrew", "heb"],
  James: ["james", "jas"],
  "1 Peter": ["1 peter", "1st peter", "first peter", "1 pet", "1pe", "1pt", "i peter"],
  "2 Peter": ["2 peter", "2nd peter", "second peter", "2 pet", "2pe", "2pt", "ii peter"],
  "1 John": ["1 john", "1st john", "first john", "1 jhn", "1jn", "i john"],
  "2 John": ["2 john", "2nd john", "second john", "2 jhn", "2jn", "ii john"],
  "3 John": ["3 john", "3rd john", "third john", "3 jhn", "3jn", "iii john"],
  Jude: ["jude", "jud"],
  Revelation: ["revelation", "revelations", "rev", "rv", "apocalypse"],
};
...
export function parseSpokenBibleReference(
  ...
  const beforeBook = clean.slice(0, bookIndex).trim();
  const afterBook = clean.slice(bookIndex + aliasLen).trim();

  // If nothing after the book name:
  if (!afterBook) {
    // Only return chapter 1 verse 1 if there was no extraneous conversational text before the book name
    if (!beforeBook || beforeBook === "book of" || beforeBook === "the book of") {
  ...
  // If the query was purely just the book name (e.g., "Genesis" or "the book of Genesis")
  if (!beforeBook || beforeBook === "book of" || beforeBook === "the book of") {
    if (!afterBook) {
      return matchLocalScripture(bibleDataInput, matchedBook, 1, 1, undefined, preferredTranslation);
    }
